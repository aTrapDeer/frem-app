          ...
          >
            <Card className="bg-white border border-slate-200 shadow-2xl rounded-2xl relative">
              <CardHeader className="relative text-center pb-6">
                <button
                  onClick={onClose}
                  className="absolute right-4 top-4 p-2 rounded-full hover:bg-slate-100 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500"
              ...
              <CardContent className="space-y-5 px-6 pb-6">
                ...
                <Button
                  ...
                  disabled={loading}
                  className="w-full bg-white text-slate-700 border border-slate-300 hover:bg-slate-50 focus:ring-2 focus:ring-blue-500"
                  size="lg"
                >
                  {loading ? (
                    "Signing in..."
                ...
                <div className="bg-slate-50 border border-slate-200 rounded-lg p-3">
                  <p className="text-xs text-slate-600 text-center">
                    <strong>Note:</strong> Email sign-in coming soon. Use Google for now.
                  </p>
                </div>
              </CardContent>
            </Card>
